...
-- -----------------------------------------------------
-- procedure state_creation
-- -----------------------------------------------------

USE `virtapi`;
DROP procedure IF EXISTS `virtapi`.`state_creation`;

DELIMITER $$
USE `virtapi`$$
CREATE PROCEDURE `state_creation`()
BEGIN
...
USE `virtapi`;
DROP procedure IF EXISTS `virtapi`.`test_create_nodes`;

DELIMITER $$
USE `virtapi`$$
CREATE PROCEDURE `test_create_nodes`(IN count INT)
BEGIN
