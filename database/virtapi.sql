...
-- Wed 06 Jan 2016 09:19:30 PM CET
...
CREATE UNIQUE INDEX `name_UNIQUE` ON `virtapi`.`cache_option` (`name` ASC);
...
-- -----------------------------------------------------
-- Table `virtapi`.`domain_state`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `virtapi`.`domain_state` ;

CREATE TABLE IF NOT EXISTS `virtapi`.`domain_state` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(32) CHARACTER SET 'utf8' NOT NULL,
  `description` VARCHAR(255) CHARACTER SET 'utf8' NOT NULL,
  PRIMARY KEY (`id`))
...
CREATE UNIQUE INDEX `description_UNIQUE` ON `virtapi`.`domain_state` (`description` ASC);

CREATE UNIQUE INDEX `state_name_UNIQUE` ON `virtapi`.`domain_state` (`name` ASC);
...
-- -----------------------------------------------------
-- Table `virtapi`.`domain`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `virtapi`.`domain` ;

CREATE TABLE IF NOT EXISTS `virtapi`.`domain` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `cores` INT NOT NULL,
  `ram` INT NOT NULL,
  ...
  `node_method_id` INT NOT NULL,
  `state_id` INT NOT NULL,
  PRIMARY KEY (`id`),
  CONSTRAINT `fk_vm_2`
    FOREIGN KEY (`state_id`)
    REFERENCES `virtapi`.`domain_state` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_vm_1`
...
CREATE INDEX `fk_state_id_vm` ON `virtapi`.`domain` (`state_id` ASC);

CREATE INDEX `fk_vm_hypervisor_id_vm` ON `virtapi`.`domain` (`node_method_id` ASC);

CREATE UNIQUE INDEX `uuid_UNIQUE` ON `virtapi`.`domain` (`uuid` ASC);
...
CREATE UNIQUE INDEX `name_UNIQUE` ON `virtapi`.`storage_type` (`name` ASC);
...
-- -----------------------------------------------------
-- Table `virtapi`.`interface`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `virtapi`.`interface` ;

CREATE TABLE IF NOT EXISTS `virtapi`.`interface` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
CREATE INDEX `fk_vm_id_vm_interface` ON `virtapi`.`interface` (`domain_id` ASC);

CREATE UNIQUE INDEX `mac_UNIQUE` ON `virtapi`.`interface` (`mac` ASC);

CREATE INDEX `fk_interface_1_idx` ON `virtapi`.`interface` (`node_id` ASC);
...
CREATE TABLE IF NOT EXISTS `virtapi`.`ipv4` (
  ...
  CONSTRAINT `fk_ipv4_1`
    ...
    REFERENCES `virtapi`.`interface` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;

CREATE INDEX `fk_vm_interface_id_ipv4` ON `virtapi`.`ipv4` (`interface_id` ASC);
...
CREATE INDEX `fk_vm_interface_id_ipv4` ON `virtapi`.`ipv6` (`interface_id` ASC);
...
CREATE INDEX `fk_vm_interface_id_vlan` ON `virtapi`.`vlan` (`interface_id` ASC);
